...
_NATIONAL_EXTRA_HOLIDAYS_FOR_P3_PERIOD = {
    ...
    2026: {
        date(2026, 1, 1): "(miércoles), Año nuevo",
        date(2026, 1, 6): "(lunes), Epifanía del Señor",
        date(2026, 4, 2): "(jueves), Jueves Santo",
        date(2026, 4, 3): "(viernes), Viernes Santo",
        date(2026, 5, 1): "(jueves), Día del Trabajador",
        # date(2026, 8, 15): "(viernes), Asunción de la Virgen",
        date(2026, 10, 12): "(domingo), Día de la Hispanidad",
        # date(2026, 11, 1): "(sábado), Todos los Santos",
        # date(2026, 12, 6): "(sábado), Día de la Constitución Española",
        date(2026, 12, 8): "(lunes), La Inmaculada Concepción",
        date(2026, 12, 25): "(jueves), Navidad",
    },
}
